...
| **EXP-006 multi-seed×3 blend equal** | 0.95048 | — | — | 단일 평균 +0.00022, blend +0.00006 — 안정화↑ 다양성↓ |
| **EXP-006 multi-seed×3 blend opt (0.25/0.25/0.50)** | **0.95053** | — | — | 신 OOF 최고. CAT 비중 변함없음 |
...
- [x] EXP-006: Multi-seed × 3 — Blend OOF **0.95053** (단일 모두 +0.0002 안정 개선)
- [ ] EXP-006 LB 점수 기록 (제출 후)
- [ ] EXP-007 후보: 다른 모델(HistGB/RF) 추가 다양성, 또는 인터랙션 FE
