...
| **EXP-010 4-way blend opt (0.25/0.20/0.40/**0.15**)** | **0.95061** | — | — | **자체 학습 OOF 천장 0.95053 돌파 (+0.00008)**. w_mlp 0.05→0.10→0.15 단계 증가 |
...
- [ ] EXP-010 LB 점수 기록 (제출 후) — `submission_exp010_blend_opt.csv`
- [ ] EXP-011 후보: PLR-MLP multi-seed×3 / RealMLP의 다른 기법 (bin-cat, inner ensemble) / 풀 RealMLP-clone 자체 구현
