...
| **EXP-008 +강화MLP blend opt (0.25/0.25/0.40/**0.10**)** | **0.95053** | — | — | OOF 천장(동점), w_mlp 0.05→0.10 (2배). MLP 한계 효과 +0.00006→+0.00011 |
...
- [ ] EXP-008 LB 점수 기록
- [ ] EXP-009 후보: MLP multi-seed×3 / epochs 120+ / width↑ / 외부 RealMLP OOF
