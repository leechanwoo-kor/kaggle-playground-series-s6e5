...
| **EXP-007 +MLP blend opt (0.25/0.25/0.45/**0.05**)** | **0.95053** | — | — | w_mlp=0.05 자연 선택. 한계 효과 +0.00006 |
...
- [ ] EXP-007 LB 점수 기록 (제출 후)
- [ ] EXP-008 후보: MLP epochs 확대 / multi-seed MLP / RealMLP 외부 OOF / stacking 패턴
